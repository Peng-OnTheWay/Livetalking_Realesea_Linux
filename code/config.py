...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=8, help="infer batch (8GB VRAM 推荐 ≤8，12GB 可 16)")
    parser.add_argument('--modelres', type=int, default=192)
    parser.add_argument('--wav2lip_model', type=str, default='256',
                        help="wav2lip model variant: 256/384")
    parser.add_argument('--modelfile', type=str, default='')
    parser.add_argument('--lip_gain', type=float, default=1.1,
                        help="口型放大系数: >1.0 放大嘴部动作, =1.0 保持原样")
    ...
    parser.add_argument('--qwen_tts_model', type=str, default='qwen3-tts-flash-realtime',
                        help="千问 TTS 模型名 (如 qwen3-tts-flash-realtime)")
